...
import DescriptionVitaminK from './DescriptionVitaminK';
import FunctionsVitaminK from './FunctionsVitaminK';
import SourcesVitaminK from './SourcesVitaminK';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin K</Typography>
