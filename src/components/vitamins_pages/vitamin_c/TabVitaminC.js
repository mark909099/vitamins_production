...
import DescriptionVitaminC from './DescriptionVitaminC';
import FunctionsVitaminC from './FunctionsVitaminC';
import SourcesVitaminC from './SourcesVitaminC';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin C</Typography>
