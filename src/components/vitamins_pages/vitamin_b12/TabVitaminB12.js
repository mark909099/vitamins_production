...
import DescriptionVitaminB12 from './DescriptionVitaminB12';
import FunctionsVitaminB12 from './FunctionsVitaminB12';
import SourcesVitaminB12 from './SourcesVitaminB12';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin B12</Typography>
