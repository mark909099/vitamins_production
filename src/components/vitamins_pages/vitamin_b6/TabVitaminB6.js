...
import DescriptionVitaminB6 from './DescriptionVitaminB6';
import FunctionsVitaminB6 from './FunctionsVitaminB6';
import SourcesVitaminB6 from './SourcesVitaminB6';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin B6</Typography>
