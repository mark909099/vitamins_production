...
import DescriptionVitaminA from './DescriptionVitaminA';
import FunctionsVitaminA from './FunctionsVitaminA';
import SourcesVitaminA from './SourcesVitaminA';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin A</Typography>
