...
import DescriptionVitaminB3 from './DescriptionVitaminB3';
import FunctionsVitaminB3 from './FunctionsVitaminB3';
import SourcesVitaminB3 from './SourcesVitaminB3';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin B3</Typography>
