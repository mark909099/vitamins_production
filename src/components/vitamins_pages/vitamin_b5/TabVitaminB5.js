...
import DescriptionVitaminB5 from './DescriptionVitaminB5';
import FunctionsVitaminB5 from './FunctionsVitaminB5';
import SourcesVitaminB5 from './SourcesVitaminB5';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin B5</Typography>
