...
import DescriptionVitaminB7 from './DescriptionVitaminB7';
import FunctionsVitaminB7 from './FunctionsVitaminB7';
import SourcesVitaminB7 from './SourcesVitaminB7';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin B7</Typography>
