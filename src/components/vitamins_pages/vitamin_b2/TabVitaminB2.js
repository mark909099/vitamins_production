...
import DescriptionVitaminB2 from './DescriptionVitaminB2';
import FunctionsVitaminB2 from './FunctionsVitaminB2';
import SourcesVitaminB2 from './SourcesVitaminB2';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin B2</Typography>
