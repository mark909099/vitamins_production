...
import DescriptionVitaminE from './DescriptionVitaminE';
import FunctionsVitaminE from './FunctionsVitaminE';
import SourcesVitaminE from './SourcesVitaminE';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin E</Typography>
