...
import DescriptionVitaminD from './DescriptionVitaminD';
import FunctionsVitaminD from './FunctionsVitaminD';
import SourcesVitaminD from './SourcesVitaminD';
...
export default function TabVitamin() {
  ...
  return (
    <div>
    <Typography className={classes.header} variant='h2'>Vitamin D</Typography>
